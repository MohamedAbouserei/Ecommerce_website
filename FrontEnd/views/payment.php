...
$allcoins=$client->viewcoins($client->getID());
$allcoins=$allcoins[0]['coins'];
...
<div class="container">
    ...
    <h3 class="text-center" style="background-color: #ffc5b00f; padding: 5px;">your current points :<?php echo $allcoins ?> points</h3>
    <br><br>
    <!--credit card div -->
    <div class="col-xs-6">
